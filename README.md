...
- The script uses graph and tree search algorithms to get the shortest path between desired start and end squares.

- I made a UI to visualize the tree and the final path chosen as the shortest path for our horsey.
